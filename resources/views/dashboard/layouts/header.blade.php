...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
  ...
  <div class="navbar-nav align-items-center">
    <div class=" nav-item dropdown">
        ...
        <div class="dropdown-menu p-0" style="min-width: 225px">
            <a class="dropdown-item w3-border-bottom p-3" href="{{ route('admin.lang') }}?lang=en">
                <i>English</i>
            </a>
            <a class="dropdown-item p-3" href="{{ route('admin.lang') }}?lang=ar">
                <i>العربية</i>
            </a>
        </div>
    </div>
  ...
  <ul class="navbar-nav flex-row align-items-center m{{ isRtl()?'e':'s' }}-auto">
    ...
    <li class="nav-item navbar-dropdown dropdown-user dropdown">
      <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
        <div class="avatar avatar-online">
          <img src="{{ asset(auth('admin')->user()->image?? 'assets/img/avatars/1.png')  }}" alt class="w-px-40 h-auto rounded-circle" />
        </div>
      </a>
      <ul class="dropdown-menu dropdown-menu-end">
          ...
          <a class="dropdown-item" href="#">
            <div class="d-flex">
              ...
              <div class="flex-grow-1">
                <span class="fw-medium d-block">{{ auth('admin')->user()->username }}</span>
        ...
        <li>
            ...
            <a class="dropdown-item"href="{{ url('admin-panel/logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
