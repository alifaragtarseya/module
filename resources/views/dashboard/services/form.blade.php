            ...
            <form class="form" action="{{ $resource->id ? route('admin.service.update', $resource->id) : route('admin.service.store') }}"
                ...
                <div class="row">
                    <div class="col-12   ">
                        ...
                        {!! Form::label('image', __('lang.image') , ['class' => 'form-label'] ) !!} (<small class="text-danger">{{ __('lang.best_size') }} : w:124 * h:100</small>)<br>
                        <img class=" image-preview-image  " width="124" height="100"   src="{{ asset($resource->image ?? 'assets/img/default.jpg' ) }}">
                        <br>
