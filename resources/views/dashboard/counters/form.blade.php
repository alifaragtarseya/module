...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content ">
      ...
      <div class="modal-body">
        <form class="form" action="{{ $resource->id ? route('admin.counter.update', $resource->id) : route('admin.counter.store') }}"
            ...
            <div class="row">
                ...
                <div class="col-12  ">
                    ...
                    {!! Form::label('number', __('lang.number') , ['class' => 'form-label'] ) !!} <br>
                    
                    {!! Form::number("number", old("number", $resource->number), ['class' => 'form-control']) !!}
