...
if (!function_exists('uploadImage')) {
    function uploadImage($file, $path, $name = null, $old_file = null)
    {
        // dd($old_file);
...
if (!function_exists('metaGenerate')) {
    function metaGenerate($meta, $title = null, $image = null, $type = "web page")
    {
        ...
        $title = $title != null ? $meta['title'] = $title : (app()->getLocale() == 'ar' ? $meta['title'] : $meta['title_en']);
        $description = app()->getLocale() == 'ar' ? $meta['description'] : $meta['description_en'];
        ...
        OpenGraph::setSiteName(Setting::getValue('site_name_' . app()->getLocale()));
        ...
        JsonLd::setSite(Setting::getValue('site_name_' . app()->getLocale()));
        JsonLd::setType($type);
